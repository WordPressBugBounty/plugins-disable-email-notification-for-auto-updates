...
<h1 id="itc_disable_update_notifications_title" data-purl="<?php echo ITC_DISABLE_UPDATE_NOTIFICATIONS_PLUGIN_DIR_URL;?>"><?php echo esc_html( get_admin_page_title() ); ?>
</h1>
